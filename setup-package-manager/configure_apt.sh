...
retry_command sudo add-apt-repository --no-update --yes --sourceslist "deb http://apt.llvm.org/${VERSION_CODENAME}/ llvm-toolchain-${VERSION_CODENAME} main"
...
retry_command sudo add-apt-repository --no-update --yes --sourceslist "deb https://apt.repos.intel.com/oneapi all main"
